...
const typeColors: Record<string, string> = {
  ...
  'Follow-up Completed': 'text-green-400 bg-green-500/10',
    ...
    return (
      <div className="rounded-xl border border-[#1e2030] bg-[#12141a] p-5">
        ...
        <div className="mt-8 flex flex-col items-center justify-center py-4 text-center">
          ...
          <p className="mt-2 text-sm text-zinc-500">No activities logged yet.</p>
          <p className="text-xs text-zinc-600">Start logging to earn XP!</p>
        </div>
      </div>
    )
  }
      ...
      <div className="relative mt-3">
        ...
        <div className="space-y-1">
          {recent.map((activity, i) => {
            ...
            return (
              <div key={activity.id} className="relative flex items-start gap-3 py-2 pl-0">
                {/* Dot */}
                <div
                  className={cn(
                ...
                <div className="min-w-0 flex-1 pt-0.5">
                  ...
                  <div className="mt-0.5 flex items-center gap-2">
                    ...
                    {activity.xpAwarded > 0 && (
                      <span className="flex items-center gap-0.5 rounded-full bg-blue-500/10 px-1.5 py-0.5 text-xs text-blue-400">
